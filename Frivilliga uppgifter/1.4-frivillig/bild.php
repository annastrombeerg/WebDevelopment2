 ...
 * Bilden laddas om automatiskt varje sekund med hjälp av HTTP-header (client pull).
 * HTML-sidan laddas om av sig själv var 5e sekund.
*/
...
header("Refresh: 1"); //Laddar om sidan varje sekund
