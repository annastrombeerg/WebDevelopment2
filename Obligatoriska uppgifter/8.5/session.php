<?php
/**
 * Läs in HTML-mallen och ersätt markören ---session-id-secure--- med det genererade sessions-idet.
 * Skriptet sätter en säker kaka med sessions-id som lever i 3 timmar. 
 */
...
setcookie("session-id", $session_id, time() + 3600 * 3, "/", "", true, true); //3 timmar

//Läs in HTML-dokumentet
$html = file_get_contents('index.html');

//Ersätt markören ---session-id-secure--- med det genererade sessions-idet
